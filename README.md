...
1. When prompted to select an upstream, choose the regular **Pantheon Drupal 8 upstream** option (not an organization upstream), so the hidden framework variable on Pantheon is properly set to Drupal.
